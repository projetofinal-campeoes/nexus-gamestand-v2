  ...
  return (
    <BackgroundDashboard config="flex flex-col">
      ...
      <GeralContainer>
        ...
        <RightSide>
          <HeaderDashboard title={`Welcome ${username}`} />
          <div className="flex flex-col items-center w-[100%] h-[645px] pr-4">
            ...
            <div className="overflow-y-auto mt-4 pr-2">
              <div className="flex flex-col gap-3 mt-4">
                ...
                <a
                  href="#"
                  className="text-primarycolor text-[12px] font-bebas"
                >
                  Read more...
                </a>
              </div>
              ...
              <div className="flex flex-col gap-4 mt-4">
                ...
                <a
                  href="#"
                  className="text-[12px] font-bebas text-primarycolor"
                >
                  Read more...
                </a>
              </div>
...
export const getServerSideProps = async ({ req, res }) => {
  ...
  const response = await axios.get(`https://nexus-gamestand-api.herokuapp.com/users/${id}`, {
    headers: {
      authorization: `Bearer ${token}`,
    },
  });
  return { props: { username: response.data.username } };
};
